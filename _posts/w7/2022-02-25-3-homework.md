...
**[ANSWER SHEET](https://docs.google.com/document/d/1TuUR69pvOsHT0Ya80S0Asi-m0h_T4XBVv0tt925-_p0/edit?usp=sharing)**




## Part 1: Maya Tetris Coloring:  <span style="color:#0000ff;"> 3%  </span>
{%comment%}[(partially covered in lab)](https://www.youtube.com/watch?v=lVzRtpTwdpc)
{%endcomment%}
...
In this challenge, you will design your snowflakes using PILLOW graphics. 
...
def snowflake(canvas_size):  
    '''  
	 ...
	 :return: img: the screen you painted on. 
...
3. You set up your own `Image` and `ImageDraw` within the snowflake function. 
4. You are returning your `Image` instance. 
5. You can test your code in the same file, but please comment out the function call and the `img.show()` statement before you submit. 
